...
def extract_features(market: dict, n_snapshots: int = 5) -> dict | None:
...
def build(input_file: str, output_file: str, n_snapshots: int = 5):
...
if __name__ == "__main__":
    print("building 5-minute dataset...")
    df = build(
        input_file="data/raw/price_history_5min.json",
        output_file="data/raw/dataset_5min.csv",
        n_snapshots=5
    )
    print(df.describe())