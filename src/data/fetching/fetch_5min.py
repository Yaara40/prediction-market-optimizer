...
def fetch(max_pages: int = 50, sample_every: int = 3) -> dict:
    after_cursor = None
...
if __name__ == "__main__":
    print("fetching 5-minute markets (15 days, every 3rd)...")
    markets = fetch(max_pages=375, sample_every=3)
    ...
    with open("data/raw/markets_5min.json", "w") as f:
        json.dump(markets, f, indent=2)
    print("saved to data/raw/markets_5min.json")