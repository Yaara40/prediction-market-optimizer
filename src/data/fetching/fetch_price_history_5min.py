...
if __name__ == "__main__":
    with open("data/raw/markets_5min.json") as f:
        raw = json.load(f)
    ...
    with open("data/raw/price_history_5min.json", "w") as f:
        json.dump(results, f, indent=2)

    print(f"\ndone: {processed - failed}/{total} saved to data/raw/price_history_5min.json")
